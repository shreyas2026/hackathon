  ...
  return (
    <div className="min-h-screen bg-orange-200 py-16 px-6 sm:px-8 lg:px-12 flex items-center justify-center">
        <div className="w-full max-w-lg mx-auto">
            {/* Glass Card Container - made larger */}
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl overflow-hidden p-10 space-y-8">
                ...
                {/* Form - larger inputs and spacing */}
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <button
                            className="flex items-center justify-center py-3 px-5 border border-transparent rounded-lg text-base font-medium text-white bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all"
                        >
                            <UserPlus className="h-5 w-5 mr-2" />
                            Register
                        </button>
                        <button
                            className="flex items-center justify-center py-3 px-5 border border-transparent rounded-lg text-base font-medium text-white bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all"
                        >
